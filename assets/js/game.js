...
var endGame = function () {
  ...
  var highSccore = localStorage.getItem("highscore");
  if (hightScore === null) {
    highSccore = 0;
  }

  //if player has more money than the high score,player has new high scre
  if (playerInfo.money > hightScore) {
    ...
    alert (alayerIno.name + " did not beat the high score of " + highScore + ". Maybe next time!");
  }
