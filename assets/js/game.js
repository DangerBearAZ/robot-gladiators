...
var startGame = function() {
  ...
  for (var i = 0; i < enemyInfo.length; i++) {
    ...
    if (playerInfo.health > 0) {
      ...
      // pass the picked pickedEnemyObj  variable's value into the fight function, where it will assume the value of the enemy.name parameter
...
var fight = function (enemy) {
  while (playerInfo.health > 0 && enemy.health > 0) {
    ...
    if (promptFight === "skip" || promptFight === "SKIP") {
      ...
      if (confirmSkip) {
        window.alert(playeName + ' has decided to skip this fight. Goodbye!');
